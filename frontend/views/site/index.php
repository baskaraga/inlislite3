...
<div class="container">
    ...
    <center>
        ...
        <p>
            ...
            <a class="btn btn-primary btn3d" target="_blank" href="<?=Url::to('perhitungan-iplm-tgm')?>"> <?=  Yii::t('app', 'Perhitungan IPLM & TGM') ?></a>
            <a class="btn btn-primary btn3d" target="_blank" href="<?=Url::to('populasipenduduk')?>"> <?=  Yii::t('app', 'Populasi Penduduk') ?></a>
        </p>
